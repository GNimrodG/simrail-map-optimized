...
namespace SMOBackend.Migrations
{
    ...
    [Migration("20260707174256_ClearSameSignal_SignalLines")]
    partial class ClearSameSignal_SignalLines
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMOBackend.Models.Entity.RoutePoint", b =>
                {
                    ...
                    b.HasIndex("PrevSignal", "NextSignal")
                        .HasDatabaseName("ix_route_points_prev_signal_next_signal");
            ...
            modelBuilder.Entity("SMOBackend.Models.Entity.SignalLine", b =>
                {
                    b.Property<string>("PrevSignal")
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)")
                    ...
                    b.HasKey("PrevSignal", "NextSignal")
                        .HasName("pk_signal_lines");

                    b.ToTable("signal_lines", (string)null);
                });
